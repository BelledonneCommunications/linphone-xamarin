...
#region Listeners
	...
	public class AccountCreatorListener : LinphoneObject
	{
		...
		private static void on_activate_account(IntPtr creator, int status, string resp)
		{
			...
			listener.on_activate_account_public?.Invoke(thiz, (Linphone.AccountCreatorStatus)status, resp);
		}
		...
		private static void on_activate_alias(IntPtr creator, int status, string resp)
		{
			...
			listener.on_activate_alias_public?.Invoke(thiz, (Linphone.AccountCreatorStatus)status, resp);
		}
		...
		private static void on_is_account_linked(IntPtr creator, int status, string resp)
		{
			...
			listener.on_is_account_linked_public?.Invoke(thiz, (Linphone.AccountCreatorStatus)status, resp);
		}
		...
		private static void on_link_account(IntPtr creator, int status, string resp)
		{
			...
			listener.on_link_account_public?.Invoke(thiz, (Linphone.AccountCreatorStatus)status, resp);
		}
		...
		private static void on_is_alias_used(IntPtr creator, int status, string resp)
		{
			...
			listener.on_is_alias_used_public?.Invoke(thiz, (Linphone.AccountCreatorStatus)status, resp);
		}
		...
		private static void on_is_account_activated(IntPtr creator, int status, string resp)
		{
			...
			listener.on_is_account_activated_public?.Invoke(thiz, (Linphone.AccountCreatorStatus)status, resp);
		}
		...
		private static void on_is_account_exist(IntPtr creator, int status, string resp)
		{
			...
			listener.on_is_account_exist_public?.Invoke(thiz, (Linphone.AccountCreatorStatus)status, resp);
		}
		...
		private static void on_update_account(IntPtr creator, int status, string resp)
		{
			...
			listener.on_update_account_public?.Invoke(thiz, (Linphone.AccountCreatorStatus)status, resp);
		}
		...
		private static void on_recover_account(IntPtr creator, int status, string resp)
		{
			...
			listener.on_recover_account_public?.Invoke(thiz, (Linphone.AccountCreatorStatus)status, resp);
		}
		...
		private static void on_create_account(IntPtr creator, int status, string resp)
		{
			...
			listener.on_create_account_public?.Invoke(thiz, (Linphone.AccountCreatorStatus)status, resp);
		}
	...
	public class CallListener : LinphoneObject
	{
		...
		private static void on_state_changed(IntPtr call, int cstate, string message)
		{
			...
			CallListener listener = thiz.CurrentCallbacks;
			listener.on_state_changed_public?.Invoke(thiz, (Linphone.CallState)cstate, message);
		}
		...
		private static void on_transfer_state_changed(IntPtr call, int cstate)
		{
			...
			CallListener listener = thiz.CurrentCallbacks;
			listener.on_transfer_state_changed_public?.Invoke(thiz, (Linphone.CallState)cstate);
		}
		...
		private static void on_info_message_received(IntPtr call, IntPtr msg)
		{
			...
			CallListener listener = thiz.CurrentCallbacks;
			listener.on_info_message_received_public?.Invoke(thiz, fromNativePtr<Linphone.InfoMessage>(msg));
		}
		...
		private static void on_ack_processing(IntPtr call, IntPtr ack, char isReceived)
		{
			...
			CallListener listener = thiz.CurrentCallbacks;
			listener.on_ack_processing_public?.Invoke(thiz, fromNativePtr<Linphone.Headers>(ack), isReceived == 0);
		}
		...
		private static void on_stats_updated(IntPtr call, IntPtr stats)
		{
			...
			CallListener listener = thiz.CurrentCallbacks;
			listener.on_stats_updated_public?.Invoke(thiz, fromNativePtr<Linphone.CallStats>(stats));
		}
	...
	public class ChatMessageListener : LinphoneObject
	{
		...
		private static void on_participant_imdn_state_changed(IntPtr msg, IntPtr state)
		{
			...
			listener.on_participant_imdn_state_changed_public?.Invoke(thiz, fromNativePtr<Linphone.ParticipantImdnState>(state));
		}
		...
		private static void on_file_transfer_recv(IntPtr message, IntPtr content, IntPtr buffer)
		{
			...
			listener.on_file_transfer_recv_public?.Invoke(thiz, fromNativePtr<Linphone.Content>(content), fromNativePtr<Linphone.Buffer>(buffer));
		}
		...
		private static void on_file_transfer_send(IntPtr message, IntPtr content, long offset, long size)
		{
			...
			listener.on_file_transfer_send_public?.Invoke(thiz, fromNativePtr<Linphone.Content>(content), offset, size);
		}
		...
		private static void on_file_transfer_progress_indication(IntPtr message, IntPtr content, long offset, long total)
		{
			...
			listener.on_file_transfer_progress_indication_public?.Invoke(thiz, fromNativePtr<Linphone.Content>(content), offset, total);
		}
		...
		private static void on_msg_state_changed(IntPtr msg, int state)
		{
			...
			listener.on_msg_state_changed_public?.Invoke(thiz, (Linphone.ChatMessageState)state);
		}
	...
	public class ChatRoomListener : LinphoneObject
	{
		...
		private static void on_state_changed(IntPtr cr, int newState)
		{
			...
			ChatRoomListener listener = thiz.CurrentCallbacks;
			listener.on_state_changed_public?.Invoke(thiz, (Linphone.ChatRoomState)newState);
		}
		...
		private static void on_participant_admin_status_changed(IntPtr cr, IntPtr eventLog)
		{
			...
			ChatRoomListener listener = thiz.CurrentCallbacks;
			listener.on_participant_admin_status_changed_public?.Invoke(thiz, fromNativePtr<Linphone.EventLog>(eventLog));
		}
		...
		private static void on_participant_removed(IntPtr cr, IntPtr eventLog)
		{
			...
			ChatRoomListener listener = thiz.CurrentCallbacks;
			listener.on_participant_removed_public?.Invoke(thiz, fromNativePtr<Linphone.EventLog>(eventLog));
		}
		...
		private static void on_participant_registration_unsubscription_requested(IntPtr cr, IntPtr participantAddr)
		{
			...
			ChatRoomListener listener = thiz.CurrentCallbacks;
			listener.on_participant_registration_unsubscription_requested_public?.Invoke(thiz, fromNativePtr<Linphone.Address>(participantAddr));
		}
		...
		private static void on_participant_device_added(IntPtr cr, IntPtr eventLog)
		{
			...
			ChatRoomListener listener = thiz.CurrentCallbacks;
			listener.on_participant_device_added_public?.Invoke(thiz, fromNativePtr<Linphone.EventLog>(eventLog));
		}
	...
	public class CoreListener : LinphoneObject
	{
		...
		private static void on_transfer_state_changed(IntPtr lc, IntPtr transfered, int newCallState)
		{
			...
			listener.on_transfer_state_changed_public?.Invoke(thiz, fromNativePtr<Linphone.Call>(transfered), (Linphone.CallState)newCallState);
		}
		...
		private static void on_friend_list_created(IntPtr lc, IntPtr list)
		{
			...
			CoreListener listener = thiz.CurrentCallbacks;
			listener.on_friend_list_created_public?.Invoke(thiz, fromNativePtr<Linphone.FriendList>(list));
		}
		...
		private static void on_subscription_state_changed(IntPtr lc, IntPtr lev, int state)
		{
			...
			CoreListener listener = thiz.CurrentCallbacks;
			listener.on_subscription_state_changed_public?.Invoke(thiz, fromNativePtr<Linphone.Event>(lev), (Linphone.SubscriptionState)state);
		}
		...
		private static void on_call_log_updated(IntPtr lc, IntPtr newcl)
		{
			...
			CoreListener listener = thiz.CurrentCallbacks;
			listener.on_call_log_updated_public?.Invoke(thiz, fromNativePtr<Linphone.CallLog>(newcl));
		}
		...
		private static void on_call_state_changed(IntPtr lc, IntPtr call, int cstate, string message)
		{
			...
			CoreListener listener = thiz.CurrentCallbacks;
			listener.on_call_state_changed_public?.Invoke(thiz, fromNativePtr<Linphone.Call>(call), (Linphone.CallState)cstate, message);
		}
		...
		private static void on_authentication_requested(IntPtr lc, IntPtr authInfo, int method)
		{
			...
			CoreListener listener = thiz.CurrentCallbacks;
			listener.on_authentication_requested_public?.Invoke(thiz, fromNativePtr<Linphone.AuthInfo>(authInfo), (Linphone.AuthMethod)method);
		}
		...
		private static void on_notify_presence_received_for_uri_or_tel(IntPtr lc, IntPtr lf, string uriOrTel, IntPtr presenceModel)
		{
			...
			CoreListener listener = thiz.CurrentCallbacks;
			listener.on_notify_presence_received_for_uri_or_tel_public?.Invoke(thiz, fromNativePtr<Linphone.Friend>(lf), uriOrTel, fromNativePtr<Linphone.PresenceModel>(presenceModel));
		}
		...
		private static void on_chat_room_state_changed(IntPtr lc, IntPtr cr, int state)
		{
			...
			CoreListener listener = thiz.CurrentCallbacks;
			listener.on_chat_room_state_changed_public?.Invoke(thiz, fromNativePtr<Linphone.ChatRoom>(cr), (Linphone.ChatRoomState)state);
		}
		...
		private static void on_buddy_info_updated(IntPtr lc, IntPtr lf)
		{
			...
			CoreListener listener = thiz.CurrentCallbacks;
			listener.on_buddy_info_updated_public?.Invoke(thiz, fromNativePtr<Linphone.Friend>(lf));
		}
		...
		private static void on_notify_received(IntPtr lc, IntPtr lev, string notifiedEvent, IntPtr body)
		{
			...
			CoreListener listener = thiz.CurrentCallbacks;
			listener.on_notify_received_public?.Invoke(thiz, fromNativePtr<Linphone.Event>(lev), notifiedEvent, fromNativePtr<Linphone.Content>(body));
		}
		...
		private static void on_new_subscription_requested(IntPtr lc, IntPtr lf, string url)
		{
			...
			CoreListener listener = thiz.CurrentCallbacks;
			listener.on_new_subscription_requested_public?.Invoke(thiz, fromNativePtr<Linphone.Friend>(lf), url);
		}
		...
		private static void on_registration_state_changed(IntPtr lc, IntPtr cfg, int cstate, string message)
		{
			...
			CoreListener listener = thiz.CurrentCallbacks;
			listener.on_registration_state_changed_public?.Invoke(thiz, fromNativePtr<Linphone.ProxyConfig>(cfg), (Linphone.RegistrationState)cstate, message);
		}
		...
		private static void on_notify_presence_received(IntPtr lc, IntPtr lf)
		{
			...
			CoreListener listener = thiz.CurrentCallbacks;
			listener.on_notify_presence_received_public?.Invoke(thiz, fromNativePtr<Linphone.Friend>(lf));
		}
		...
		private static void on_message_received(IntPtr lc, IntPtr room, IntPtr message)
		{
			...
			CoreListener listener = thiz.CurrentCallbacks;
			listener.on_message_received_public?.Invoke(thiz, fromNativePtr<Linphone.ChatRoom>(room), fromNativePtr<Linphone.ChatMessage>(message));
		}
		...
		private static void on_ec_calibration_result(IntPtr lc, int status, int delayMs)
		{
			...
			CoreListener listener = thiz.CurrentCallbacks;
			listener.on_ec_calibration_result_public?.Invoke(thiz, (Linphone.EcCalibratorStatus)status, delayMs);
		}
		...
		private static void on_subscribe_received(IntPtr lc, IntPtr lev, string subscribeEvent, IntPtr body)
		{
			...
			CoreListener listener = thiz.CurrentCallbacks;
			listener.on_subscribe_received_public?.Invoke(thiz, fromNativePtr<Linphone.Event>(lev), subscribeEvent, fromNativePtr<Linphone.Content>(body));
		}
		...
		private static void on_info_received(IntPtr lc, IntPtr call, IntPtr msg)
		{
			...
			CoreListener listener = thiz.CurrentCallbacks;
			listener.on_info_received_public?.Invoke(thiz, fromNativePtr<Linphone.Call>(call), fromNativePtr<Linphone.InfoMessage>(msg));
		}
		...
		private static void on_call_stats_updated(IntPtr lc, IntPtr call, IntPtr stats)
		{
			...
			CoreListener listener = thiz.CurrentCallbacks;
			listener.on_call_stats_updated_public?.Invoke(thiz, fromNativePtr<Linphone.Call>(call), fromNativePtr<Linphone.CallStats>(stats));
		}
		...
		private static void on_friend_list_removed(IntPtr lc, IntPtr list)
		{
			...
			CoreListener listener = thiz.CurrentCallbacks;
			listener.on_friend_list_removed_public?.Invoke(thiz, fromNativePtr<Linphone.FriendList>(list));
		}
		...
		private static void on_configuring_status(IntPtr lc, int status, string message)
		{
			...
			CoreListener listener = thiz.CurrentCallbacks;
			listener.on_configuring_status_public?.Invoke(thiz, (Linphone.ConfiguringState)status, message);
		}
		...
		private static void on_call_created(IntPtr lc, IntPtr call)
		{
			...
			CoreListener listener = thiz.CurrentCallbacks;
			listener.on_call_created_public?.Invoke(thiz, fromNativePtr<Linphone.Call>(call));
		}
		...
		private static void on_publish_state_changed(IntPtr lc, IntPtr lev, int state)
		{
			...
			CoreListener listener = thiz.CurrentCallbacks;
			listener.on_publish_state_changed_public?.Invoke(thiz, fromNativePtr<Linphone.Event>(lev), (Linphone.PublishState)state);
		}
		...
		private static void on_call_encryption_changed(IntPtr lc, IntPtr call, char on, string authenticationToken)
		{
			...
			CoreListener listener = thiz.CurrentCallbacks;
			listener.on_call_encryption_changed_public?.Invoke(thiz, fromNativePtr<Linphone.Call>(call), on == 0, authenticationToken);
		}
		...
		private static void on_is_composing_received(IntPtr lc, IntPtr room)
		{
			...
			CoreListener listener = thiz.CurrentCallbacks;
			listener.on_is_composing_received_public?.Invoke(thiz, fromNativePtr<Linphone.ChatRoom>(room));
		}
		...
		private static void on_message_received_unable_decrypt(IntPtr lc, IntPtr room, IntPtr message)
		{
			...
			CoreListener listener = thiz.CurrentCallbacks;
			listener.on_message_received_unable_decrypt_public?.Invoke(thiz, fromNativePtr<Linphone.ChatRoom>(room), fromNativePtr<Linphone.ChatMessage>(message));
		}
		...
		private static void on_version_update_check_result_received(IntPtr lc, int result, string version, string url)
		{
			...
			CoreListener listener = thiz.CurrentCallbacks;
			listener.on_version_update_check_result_received_public?.Invoke(thiz, (Linphone.VersionUpdateCheckResult)result, version, url);
		}
		...
		private static void on_global_state_changed(IntPtr lc, int gstate, string message)
		{
			...
			CoreListener listener = thiz.CurrentCallbacks;
			listener.on_global_state_changed_public?.Invoke(thiz, (Linphone.GlobalState)gstate, message);
		}
		...
		private static void on_log_collection_upload_state_changed(IntPtr lc, int state, string info)
		{
			...
			CoreListener listener = thiz.CurrentCallbacks;
			listener.on_log_collection_upload_state_changed_public?.Invoke(thiz, (Linphone.CoreLogCollectionUploadState)state, info);
		}
		...
		private static void on_dtmf_received(IntPtr lc, IntPtr call, int dtmf)
		{
			...
			CoreListener listener = thiz.CurrentCallbacks;
			listener.on_dtmf_received_public?.Invoke(thiz, fromNativePtr<Linphone.Call>(call), dtmf);
		}
	...
	public class FriendListListener : LinphoneObject
	{
		...
		private static void on_sync_status_changed(IntPtr list, int status, string msg)
		{
			...
			listener.on_sync_status_changed_public?.Invoke(thiz, (Linphone.FriendListSyncStatus)status, msg);
		}
		...
		private static void on_contact_created(IntPtr list, IntPtr lf)
		{
			...
			listener.on_contact_created_public?.Invoke(thiz, fromNativePtr<Linphone.Friend>(lf));
		}
		...
		private static void on_contact_deleted(IntPtr list, IntPtr lf)
		{
			...
			listener.on_contact_deleted_public?.Invoke(thiz, fromNativePtr<Linphone.Friend>(lf));
		}
...
#region Classes
	...
	public class AccountCreator : LinphoneObject
	{
		...
		public Linphone.ProxyConfig Configure()
		{
			...
			return fromNativePtr<Linphone.ProxyConfig>(ptr, true);
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.ProxyConfig CreateProxyConfig()
		{
			...
			return fromNativePtr<Linphone.ProxyConfig>(ptr, false);
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
	...
	public class AuthInfo : LinphoneObject
	{
		...
		public Linphone.AuthInfo Clone()
		{
			...
			return fromNativePtr<Linphone.AuthInfo>(ptr, true);
		}
	}
	/// <summary>
	...
	public class Buffer : LinphoneObject
	{
		...
		public static Linphone.Buffer NewFromData(uint data, long size)
		{
			...
			return fromNativePtr<Linphone.Buffer>(ptr, true);
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
	...
	public class Call : LinphoneObject
	{
		...
		public Linphone.CallLog CallLog
		{
			get
			{
				...
				return fromNativePtr<Linphone.CallLog>(ptr, true);
			}
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.Conference Conference
		{
			get
			{
				...
				return fromNativePtr<Linphone.Conference>(ptr, true);
			}
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.CallListener CurrentCallbacks
		{
			get
			{
				...
				return fromNativePtr<Linphone.CallListener>(ptr, true);
			}
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.CallParams CurrentParams
		{
			get
			{
				...
				return fromNativePtr<Linphone.CallParams>(ptr, true);
			}
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.ErrorInfo ErrorInfo
		{
			get
			{
				...
				return fromNativePtr<Linphone.ErrorInfo>(ptr, true);
			}
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.Player Player
		{
			get
			{
				...
				return fromNativePtr<Linphone.Player>(ptr, true);
			}
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.CallStats GetStats(Linphone.StreamType type)
		{
			...
			return fromNativePtr<Linphone.CallStats>(ptr, true);
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
	...
	public class CallParams : LinphoneObject
	{
		...
		public Linphone.VideoDefinition ReceivedVideoDefinition
		{
			get
			{
				...
				return fromNativePtr<Linphone.VideoDefinition>(ptr, true);
			}
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
	...
	public class ChatMessage : LinphoneObject
	{
		...
		public Linphone.Content FileTransferInformation
		{
			get
			{
				...
				return fromNativePtr<Linphone.Content>(ptr, true);
			}
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		{
			return MarshalBctbxList<Linphone.ParticipantImdnState>(linphone_chat_message_get_participants_by_imdn_state(nativePtr, (int)state));
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
	...
	public class ChatRoom : LinphoneObject
	{
		...
		public Linphone.ChatRoomListener CurrentCallbacks
		{
			get
			{
				...
				return fromNativePtr<Linphone.ChatRoomListener>(ptr, true);
			}
			set
			{
		...
		public Linphone.ChatMessage LastMessageInHistory
		{
			get
			{
				...
				return fromNativePtr<Linphone.ChatMessage>(ptr, true);
			}
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.Participant Me
		{
			get
			{
				...
				return fromNativePtr<Linphone.Participant>(ptr, true);
			}
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		/// </summary>
		public void AddCompatibleParticipants(Linphone.Address deviceAddr, IEnumerable<Linphone.Address> participantsCompatible)
		{
			linphone_chat_room_add_compatible_participants(nativePtr, deviceAddr != null ? deviceAddr.nativePtr : IntPtr.Zero, ObjectArrayToBctbxList<Linphone.Address>(participantsCompatible));
		...
		{
			linphone_chat_room_add_participants(nativePtr, ObjectArrayToBctbxList<Linphone.Address>(addresses));
		...
		public Linphone.ChatMessage CreateEmptyMessage()
		{
			...
			return fromNativePtr<Linphone.ChatMessage>(ptr, false);
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		{
			return MarshalBctbxList<Linphone.ChatMessage>(linphone_chat_room_get_history(nativePtr, nbMessage));
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		{
			return MarshalBctbxList<Linphone.EventLog>(linphone_chat_room_get_history_events(nativePtr, nbEvents));
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		{
			return MarshalBctbxList<Linphone.EventLog>(linphone_chat_room_get_history_message_events(nativePtr, nbEvents));
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		{
			return MarshalBctbxList<Linphone.ChatMessage>(linphone_chat_room_get_history_range(nativePtr, begin, end));
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		{
			return MarshalBctbxList<Linphone.EventLog>(linphone_chat_room_get_history_range_events(nativePtr, begin, end));
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		{
			return MarshalBctbxList<Linphone.EventLog>(linphone_chat_room_get_history_range_message_events(nativePtr, begin, end));
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		/// Set the participant device. 
		/// </summary>
		public void SetParticipantDevices(Linphone.Address partAddr, IEnumerable<Linphone.Address> partDevices)
		{
			linphone_chat_room_set_participant_devices(nativePtr, partAddr != null ? partAddr.nativePtr : IntPtr.Zero, ObjectArrayToBctbxList<Linphone.Address>(partDevices));
	...
	public class ConferenceParams : LinphoneObject
	{
		...
		public Linphone.ConferenceParams Clone()
		{
			...
			return fromNativePtr<Linphone.ConferenceParams>(ptr, true);
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
	...
	public class Config : LinphoneObject
	{
		...
		public static Linphone.Config NewFromBuffer(string buffer)
		{
			...
			return fromNativePtr<Linphone.Config>(ptr, true);
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
	...
	public class Core : LinphoneObject
	{
		...
		public Linphone.Range AudioPortsRange
		{
			get
			{
				...
				return fromNativePtr<Linphone.Range>(ptr, true);
			}
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.CoreListener CurrentCallbacks
		{
			get
			{
				...
				return fromNativePtr<Linphone.CoreListener>(ptr, true);
			}
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.ImNotifPolicy ImNotifPolicy
		{
			get
			{
				...
				return fromNativePtr<Linphone.ImNotifPolicy>(ptr, true);
			}
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.NatPolicy NatPolicy
		{
			get
			{
				...
				return fromNativePtr<Linphone.NatPolicy>(ptr, true);
			}
			set
			{
		...
		public Linphone.Transports Transports
		{
			get
			{
				...
				return fromNativePtr<Linphone.Transports>(ptr, true);
			}
			set
			{
		...
		public Linphone.Tunnel Tunnel
		{
			get
			{
				...
				return fromNativePtr<Linphone.Tunnel>(ptr, true);
			}
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.VideoActivationPolicy VideoActivationPolicy
		{
			get
			{
				...
				return fromNativePtr<Linphone.VideoActivationPolicy>(ptr, true);
			}
			set
			{
		...
		public Linphone.AccountCreator CreateAccountCreator(string xmlrpcUrl)
		{
			...
			return fromNativePtr<Linphone.AccountCreator>(ptr, false);
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.AuthInfo CreateAuthInfo(string username, string userid, string passwd, string ha1, string realm, string domain)
		{
			...
			return fromNativePtr<Linphone.AuthInfo>(ptr, false);
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.CallLog CreateCallLog(Linphone.Address from, Linphone.Address to, Linphone.CallDir dir, int duration, long startTime, long connectedTime, Linphone.CallStatus status, bool videoEnabled, float quality)
		{
			...
			return fromNativePtr<Linphone.CallLog>(ptr, false);
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.CallParams CreateCallParams(Linphone.Call call)
		{
			...
			return fromNativePtr<Linphone.CallParams>(ptr, false);
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.ConferenceParams CreateConferenceParams()
		{
			...
			return fromNativePtr<Linphone.ConferenceParams>(ptr, false);
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.Conference CreateConferenceWithParams(Linphone.ConferenceParams parameters)
		{
			...
			return fromNativePtr<Linphone.Conference>(ptr, false);
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.Config CreateConfig(string filename)
		{
			...
			return fromNativePtr<Linphone.Config>(ptr, false);
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.Content CreateContent()
		{
			...
			return fromNativePtr<Linphone.Content>(ptr, false);
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.Friend CreateFriend()
		{
			...
			return fromNativePtr<Linphone.Friend>(ptr, false);
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.FriendList CreateFriendList()
		{
			...
			return fromNativePtr<Linphone.FriendList>(ptr, false);
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.InfoMessage CreateInfoMessage()
		{
			...
			return fromNativePtr<Linphone.InfoMessage>(ptr, false);
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.Player CreateLocalPlayer(string soundCardName, string videoDisplayName, IntPtr windowId)
		{
			...
			return fromNativePtr<Linphone.Player>(ptr, false);
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.MagicSearch CreateMagicSearch()
		{
			...
			return fromNativePtr<Linphone.MagicSearch>(ptr, false);
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.NatPolicy CreateNatPolicy()
		{
			...
			return fromNativePtr<Linphone.NatPolicy>(ptr, false);
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.PresenceActivity CreatePresenceActivity(Linphone.PresenceActivityType acttype, string description)
		{
			...
			return fromNativePtr<Linphone.PresenceActivity>(ptr, false);
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.PresenceModel CreatePresenceModel()
		{
			...
			return fromNativePtr<Linphone.PresenceModel>(ptr, false);
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.PresenceNote CreatePresenceNote(string content, string lang)
		{
			...
			return fromNativePtr<Linphone.PresenceNote>(ptr, false);
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.PresencePerson CreatePresencePerson(string id)
		{
			...
			return fromNativePtr<Linphone.PresencePerson>(ptr, false);
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.XmlRpcSession CreateXmlRpcSession(string url)
		{
			...
			return fromNativePtr<Linphone.XmlRpcSession>(ptr, false);
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		{
			return MarshalBctbxList<Linphone.Address>(linphone_core_find_contacts_by_char(nativePtr, filter, sipOnly ? (char)1 : (char)0));
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.Event Publish(Linphone.Address resource, string ev, int expires, Linphone.Content body)
		{
			...
			return fromNativePtr<Linphone.Event>(ptr, true);
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		/// <summary>
		/// Start a <see cref="Linphone.Core" /> object after it has been instantiated. 
		/// </summary>
		public void Start()
		{
	...
	public class DialPlan : LinphoneObject
	{
		...
		public static Linphone.DialPlan ByCcc(string ccc)
		{
			...
			return fromNativePtr<Linphone.DialPlan>(ptr, true);
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
	...
	public class Factory : LinphoneObject
	{
		...
		static public Linphone.Factory Instance
		{
			get
			{
				...
				return fromNativePtr<Linphone.Factory>(ptr, true);
			}
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.Buffer CreateBuffer()
		{
			...
			return fromNativePtr<Linphone.Buffer>(ptr, false);
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.Core CreateCore(Linphone.CoreListener cbs, string configPath, string factoryConfigPath)
		{
			...
			return fromNativePtr<Linphone.Core>(ptr, false);
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.ErrorInfo CreateErrorInfo()
		{
			...
			return fromNativePtr<Linphone.ErrorInfo>(ptr, false);
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.Range CreateRange()
		{
			...
			return fromNativePtr<Linphone.Range>(ptr, false);
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.Transports CreateTransports()
		{
			...
			return fromNativePtr<Linphone.Transports>(ptr, false);
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.TunnelConfig CreateTunnelConfig()
		{
			...
			return fromNativePtr<Linphone.TunnelConfig>(ptr, false);
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.Vcard CreateVcard()
		{
			...
			return fromNativePtr<Linphone.Vcard>(ptr, false);
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.VideoActivationPolicy CreateVideoActivationPolicy()
		{
			...
			return fromNativePtr<Linphone.VideoActivationPolicy>(ptr, false);
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.VideoDefinition CreateVideoDefinition(uint width, uint height)
		{
			...
			return fromNativePtr<Linphone.VideoDefinition>(ptr, false);
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
	...
	public class Friend : LinphoneObject
	{
		...
		public Linphone.Vcard Vcard
		{
			get
			{
				...
				return fromNativePtr<Linphone.Vcard>(ptr, true);
			}
			set
			{
	...
	public class LoggingService : LinphoneObject
	{
		...
		static public Linphone.LoggingService Instance
		{
			get
			{
				...
				return fromNativePtr<Linphone.LoggingService>(ptr, true);
			}
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
	...
	public class MagicSearch : LinphoneObject
	{
		...
		{
			return MarshalBctbxList<Linphone.SearchResult>(linphone_magic_search_get_contact_list_from_filter(nativePtr, filter, domain));
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
	...
	public class PresenceModel : LinphoneObject
	{
		...
		public Linphone.PresenceActivity Activity
		{
			get
			{
				...
				return fromNativePtr<Linphone.PresenceActivity>(ptr, true);
			}
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.PresenceNote GetNote(string lang)
		{
			...
			return fromNativePtr<Linphone.PresenceNote>(ptr, true);
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
		...
		public Linphone.PresencePerson GetNthPerson(uint idx)
		{
			...
			return fromNativePtr<Linphone.PresencePerson>(ptr, true);
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
	...
	public class XmlRpcSession : LinphoneObject
	{
		...
		public Linphone.XmlRpcRequest CreateRequest(Linphone.XmlRpcArgType returnType, string method)
		{
			...
			return fromNativePtr<Linphone.XmlRpcRequest>(ptr, false);
		}
		[DllImport(LinphoneWrapper.LIB_NAME, CallingConvention = CallingConvention.Cdecl)]
